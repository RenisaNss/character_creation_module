...
def defence(char_name, char_class):
    """Возвращает количество заблокированного урона."""
    if char_class == 'warrior':
...
def special(char_name, char_class):
    """Возвращает импрув характеристик после применения специального умения."""
    if char_class == 'warrior':
...
def start_training(char_name, char_class):
    """Приветствует перед тренировкой, дает возможность скипать тренировку."""
    if char_class == 'warrior':
...
def choice_char_class():
    """Выбор персонажа, помещает его в переменную."""
    approve_choice = None
    char_class = None
